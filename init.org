...
Overflow. Another way would be to use el-patch to remove these
...
package]]. But for now I'll just leave this note.
...
I was convinced that I could move to straight.el by a blog post by
...
around autoloading). However, the [[the melpa issues on [[the melpa issues on https://github.com/melpa/melpa/issues/7312#issuecomment-751142747][melpa packing issues on 2020-12-24]],
...
#+begin_src emacs-lisp
(use-package org-ref)
(require 'org-ref) ;; Requiring org-ref slows startup way way down
#+end_src
