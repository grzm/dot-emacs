...
(use-package org
  :custom-face
  (org-level-1 ((t (:height 1.0 :inherit nil))))
  (org-level-2 ((t (:height 1.0 :inherit nil))))
  (org-level-3 ((t (:height 1.0 :inherit nil))))
  (org-level-4 ((t (:height 1.0 :inherit nil))))
  (org-level-5 ((t (:height 1.0 :inherit nil))))
  :config
  (setq
...
;;         org-roam-graph-executable "/path/to/neato"
;;         org-roam-graph-viewer "open"
;;         org-roam-capture-templates '(("z" "zettelkästen" plain #'org-roam--capture-get-point "%?"
;;                                      :file-name "%<%Y-%m-%d--%H-%M-%SZ>--${slug}"
;;                                      :head "#+TITLE: ${title}\n"
;;                                      :unnarrowed t)))
